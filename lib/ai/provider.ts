...
import { getGroqStudyPlan } from "./groqStudyPlan";
...
import type { StudyPlan, StudyPlanContext } from "./studyPlan";
...
export async function getStudyPlan(context: StudyPlanContext): Promise<StudyPlan> {
  return getGroqStudyPlan(context);
}
...
export type { StudyPlan, StudyPlanContext, StudyPlanAction, StudyPlanDay, StudyPlanActionType } from "./studyPlan";
